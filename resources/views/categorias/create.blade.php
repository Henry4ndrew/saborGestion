...
<div class="max-w-2xl mx-auto" x-data="{
    ...
    iconsDatabase: {
        comida: [
            ...
            { name: 'fa-taco', label: 'Taco', emoji: '🌮' },
            { name: 'fa-burrito', label: 'Burrito', emoji: '🌯' },
            { name: 'fa-ramen', label: 'Ramen', emoji: '🍜' },
            { name: 'fa-bowl-food', label: 'Bowl', emoji: '🥣' },
            { name: 'fa-plate-wheat', label: 'Plato', emoji: '🍽️' },
            { name: 'fa-drumstick-bite', label: 'Pollo', emoji: '🍗' },
            { name: 'fa-french-fries', label: 'Papas fritas', emoji: '🍟' },
        ],
        bebidas: [
        ...
        utensilios: [
            ...
            { name: 'fa-microwave', label: 'Microondas', emoji: '📡' },
            { name: 'fa-oven', label: 'Horno', emoji: '🔥' },
            { name: 'fa-refrigerator', label: 'Refrigerador', emoji: '🧊' },
            { name: 'fa-knife', label: 'Cuchillo', emoji: '🔪' },
            { name: 'fa-fork', label: 'Tenedor', emoji: '🍴' },
            { name: 'fa-spoon', label: 'Cuchara', emoji: '🥄' },
            { name: 'fa-chopsticks', label: 'Palillos', emoji: '🥢' },
            { name: 'fa-grill', label: 'Parrilla', emoji: '🔥' },
            { name: 'fa-wok', label: 'Wok', emoji: '🍳' },
            { name: 'fa-pot-food', label: 'Olla', emoji: '🍲' },
        ],
        restaurante: [
        ...
        general: [
            ...
            { name: 'fa-flower', label: 'Flor', emoji: '🌸' },
        ]
    },
